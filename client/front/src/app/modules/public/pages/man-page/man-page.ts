  ...
  loadInitialData(): void {
    ...
    forkJoin({
      ...
      next: ({ products, categories }) => {
        // Filter for men's products based on category
        this.allProducts = products.filter(product => {
          if (Array.isArray(product.categoryID)) {
            return product.categoryID.some((cat: any) => {
              ...
              return categoryName.toLowerCase().includes('men') || 
                     categoryName.toLowerCase().includes('man') || 
        ...
        // Filter categories to show only men's related categories
